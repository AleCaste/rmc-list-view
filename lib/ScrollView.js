...
var ScrollView = function (_React$Component) {
  ...
  (0, _createClass3['default'])(ScrollView, [{
    ...
    value: function render() {
      ...
      var containerProps = {
        ref: function ref(el) {
          return _this3.ScrollViewRef = el || _this3.ScrollViewRef;
        },
      ...
      var contentContainerProps = {
        ref: function ref(el) {
          return _this3.InnerScrollViewRef = el;
        },
...
var _initialiseProps = function _initialiseProps() {
  ...
  this.getMetrics = function () {
    var isVertical = !_this4.props.horizontal;
    if (_this4.props.useBodyScroll) {
      ...
      return {
        ...
        contentLength: _this4.ScrollViewRef ? _this4.ScrollViewRef[isVertical ? 'scrollHeight' : 'scrollWidth'] : 0,
        offset: scrollNode[isVertical ? 'scrollTop' : 'scrollLeft']
      };
    }
    return {
      visibleLength: _this4.ScrollViewRef[isVertical ? 'offsetHeight' : 'offsetWidth'],
      contentLength: _this4.ScrollViewRef[isVertical ? 'scrollHeight' : 'scrollWidth'],
      offset: _this4.ScrollViewRef[isVertical ? 'scrollTop' : 'scrollLeft']
    };
  };

  this.getInnerViewNode = function () {
    return _this4.InnerScrollViewRef;
  };
  ...
  this.scrollTo = function () {
    if (_this4.props.useBodyScroll) {
      ...
      _this4.ScrollViewRef.scrollLeft = arguments.length <= 0 ? undefined : arguments[0];
      _this4.ScrollViewRef.scrollTop = arguments.length <= 1 ? undefined : arguments[1];
    }
  };
};
